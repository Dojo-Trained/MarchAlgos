...
document links
The parseInt() function is used to accept the string ,radix parameter and convert it into an integer.
The radix parameter is used to specify which numeral system to be used, for example, 
a radix of 16 (hexadecimal) indicates that the number in the string should be parsed 
